(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__e874229e._.js",
...
"[project]/lib/supabase/client.ts [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const SUPABASE_URL = ("TURBOPACK compile-time value", "https://hypweqpfjppkszjvoywt.supabase.co");
...
function getSupabaseBrowserClient() {
    if (!browserClient) {
        browserClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createBrowserClient"])(SUPABASE_URL, SUPABASE_ANON_KEY);
    }
    return browserClient;
}
async function createSupabaseServerClient(req) {
    const cookieStore = req ? req.cookies : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["cookies"])();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createServerClient"])(SUPABASE_URL, SUPABASE_ANON_KEY, {
        cookies: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/client.ts [middleware-edge] (ecmascript)"); // <-- yangi nom
...
async function updateSession(request) {
    ...
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createSupabaseServerClient"])(request);
    let user = null;
    try {
        const { data: { user: gotUser } } = await supabase.auth.getUser();
        user = gotUser;
        console.log("[middleware] supabase.getUser ->", Boolean(user));
    } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e874229e._.js.map